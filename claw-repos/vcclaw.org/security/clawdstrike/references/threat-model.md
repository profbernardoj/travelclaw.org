...
4. Identify trust boundaries relevant to the host and [REDACTED].
...
- **Assets**: <credentials, tokens, conversations, file system, channels, [REDACTED] control>
- **Actors**: <external attackers, malicious skill authors, compromised accounts, insiders>
- **Entry points**: <[REDACTED]/control UI, skills/plugins, channels, browser control, node execution>
